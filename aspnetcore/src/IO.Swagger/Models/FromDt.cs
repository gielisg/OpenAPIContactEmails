...
{ 
    ...
    { 
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((FromDt)obj);
        }

        /// <summary>
        /// Returns true if FromDt instances are equal
        /// </summary>
        /// <param name="other">Instance of FromDt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FromDt other)
        {
        ...
        public static bool operator ==(FromDt left, FromDt right)
        {
